...
class CircleShape extends LogoShape {
  ...
  render() {
    return `
      <circle cx="50" cy="50" r="40" fill="${this.bgColor}" stroke="${this.textColor}" stroke-width="5" />
    `;
  }
}
...
class SquareShape extends LogoShape {
  ...
  render() {
    return `
      <rect x="20" y="20" width="60" height="60" fill="${this.bgColor}" stroke="${this.textColor}" stroke-width="5" />
    `;
  }
}
...
class TriangleShape extends LogoShape {
  ...
  render() {
    return `
      <polygon points="50,10 90,90 10,90" fill="${this.bgColor}" stroke="${this.textColor}" stroke-width="5" />
    `;
  }
}
